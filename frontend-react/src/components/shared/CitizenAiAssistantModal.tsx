    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-0 sm:p-4 md:p-6 bg-gray-950/80 backdrop-blur-md">
        ...
        >
          ...
          {/* ── HEADER ── */}
          <div className="p-3 sm:px-6 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between bg-slate-50/90 dark:bg-slate-900/90 backdrop-blur-md shrink-0">
            <div>
              <div className="flex items-center gap-2">
                <h2 className="font-bold text-slate-900 dark:text-white text-sm sm:text-base">
                  IBM AI Citizen Assistant
                </h2>
                <span className="flex items-center gap-1 px-2 py-0.5 text-[9px] font-bold uppercase tracking-wider bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 rounded-full border border-blue-200 dark:border-blue-700/50">
            ...
            <div className="flex items-center gap-2">
              ...
              {availableProperties.length > 0 && (
                <div className="relative">
                  <button
                    ...
                    className="flex items-center gap-1 px-2.5 py-1.5 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 text-xs font-semibold rounded-xl border border-slate-200 dark:border-slate-700 transition-colors"
                  ...
                  >
                    ...
                    <span className="sm:hidden text-[11px] truncate max-w-[90px]">
              ...
              <div className="relative group">
                <button className="flex items-center gap-1 px-2.5 py-1.5 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 text-xs font-semibold rounded-xl border border-slate-200 dark:border-slate-700 transition-colors">
            ...
            <div className="border-b border-slate-200/70 dark:border-slate-800 bg-slate-50/90 dark:bg-slate-800/70 transition-all shrink-0">
              {isPropertyCollapsed ? (
                ...
                <button
                  ...
                  className="w-full px-3 sm:px-6 py-2 flex items-center justify-between text-left hover:bg-slate-100/80 dark:hover:bg-slate-800 transition-colors"
                >
                  <div className="flex items-center gap-2 min-w-0">
                    <span className="px-1.5 py-0.5 text-[9px] font-bold bg-slate-200 dark:bg-slate-700 text-slate-800 dark:text-slate-200 rounded">
                      #{activeProperty.surveyNumber || '342/A'}
                    </span>
                    <span className="font-bold text-slate-800 dark:text-slate-200 text-xs truncate max-w-[160px] sm:max-w-none">
                      {activeProperty.title}
                    </span>
                    <span className="text-[11px] text-slate-400 hidden sm:inline">•</span>
                    <span className="text-[11px] text-slate-500 dark:text-slate-400 hidden sm:inline">
                      {activeProperty.area} Acres • ₹{activeProperty.price?.toLocaleString('en-IN')}
                    </span>
                  </div>
                  <div className="flex items-center gap-2 shrink-0">
                    ...
                    <span className="text-[10px] text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 font-semibold flex items-center gap-0.5">
                ...
                <div className="p-3 sm:px-6 flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3 min-w-0">
                    <div className="w-10 h-10 rounded-xl bg-slate-800 overflow-hidden shrink-0 border border-slate-200 dark:border-slate-700 shadow-xs">
                      <img
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2 flex-wrap">
                        <h3 className="font-bold text-slate-900 dark:text-white text-xs sm:text-sm truncate max-w-[200px] sm:max-w-xs">
                          {activeProperty.title}
                        </h3>
                        <span className="px-1.5 py-0.5 text-[9px] font-semibold bg-slate-200 dark:bg-slate-700 text-slate-800 dark:text-slate-200 rounded">
                          Survey #{activeProperty.surveyNumber || '342/A'}
                        </span>
                        {activeProperty.status === 'APPROVED' && (
                          <span className="px-1.5 py-0.5 text-[9px] font-semibold bg-emerald-100 text-emerald-800 dark:bg-emerald-950/60 dark:text-emerald-300 rounded">
                            Verified
                          </span>
                        )}
                      </div>
                      ...
                      <div className="flex items-center gap-2 text-[11px] text-slate-500 dark:text-slate-400 mt-0.5 flex-wrap">
                        ...
                        <span>•</span>
                        <span>{activeProperty.area} Acres</span>
                        <span>•</span>
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <div className="px-2 py-0.5 bg-emerald-500/10 border border-emerald-500/20 rounded-md text-center">
                      <div className="text-[8px] uppercase font-bold text-emerald-600 dark:text-emerald-400">Trust</div>
                      <div className="text-[11px] font-black text-emerald-600 dark:text-emerald-400">92/100</div>
                    </div>
                    <button
