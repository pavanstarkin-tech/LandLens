...
| <img src="https://github.com/pavanstarkin-tech.png" width="65" style="border-radius: 15px;"/> | [@pavanstarkin-tech](https://github.com/pavanstarkin-tech) | **Pavan Kumar Swamy** | **Technical Architect & Core Full-Stack Lead**<br>Conceived and built the core architecture; designed 3NF database schema; built React 18 + Vite UI, glassmorphism dashboards, Mapbox GL JS engine, 360° panorama viewer, and API integration. |
