...
| :---: | :--- | :--- |
| <img src="https://github.com/santhipriyaa27.png" width="60" style="border-radius: 15px;"/> | [@santhipriyaa27](https://github.com/santhipriyaa27)<br>*(Santhi Priya)* | **Team Lead, DevOps & QA Automation**<br>Project manager; architected Jenkins CI/CD automation pipelines, SonarQube code quality auditing (`automate_sonar.py`), bug tracking, test execution, and quality control. |
